...
>
> All your tutorials live in one central library (`~/coding-tutor-tutorials/`) that works across all your projects. Use `/prompts:teach-me` to learn something new, `/prompts:quiz-me` to test your retention with spaced repetition.
